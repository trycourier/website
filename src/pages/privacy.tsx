      ...
      <Section>
        <Container bg="transparent">
          <PageWrapper>
            ...
            <p>
              trycourier.com, Inc. operates the https://www.trycourier.app
              website, which provides the SERVICE.
            </p>
            <p>
              This page is used to inform website visitors regarding our
              policies with the collection, use, and disclosure of Personal
              Information if anyone decided to use our Service, the Courier
              website.
            </p>
            <p>
            ...
            <p>
              ...
              information, including but not limited to your email address. The
