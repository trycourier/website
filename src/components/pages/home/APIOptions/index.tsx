      ...
      >
        ...
        >
          <Tag
            sx={{
              color: "#791EB3",
              backgroundColor: "rgba(121, 30, 179, 0.16)",
              fontSize: "10px",
              fontWeight: "600",
              marginBottom: "18px",
            }}
          ...
          <Text mt={"32px"} w={"100%"} variant="body1" mb={"42px"}>
            With just one easy-to-use API, you can access client libraries
            written in the most popular programming languages, and deploy
            notifications faster with cleaner code.
          </Text>
