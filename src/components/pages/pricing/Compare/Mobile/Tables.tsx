...
const Developer = () => (
  <Accordion w={{ base: "100%" }} allowToggle>
    {plansData.map((plan) => (
      <AccordionItem
        borderTop={plan.planNameKey == "developerData" ? "none" : "auto"}
        borderBottom={plan.planNameKey === "enterpriseData" ? "none" : "auto"}
        key={plan.title}
        p={plan.planNameKey == "developerData" ? "0px 0 20px" : "28px 0 20px"}
      >
