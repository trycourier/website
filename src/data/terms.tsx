  ...
  <>
    ...
    <ul>
      ...
      <li>
        ...
        "Us" or "Our" in this Agreement) refers to trycourier.com, Inc., 182
        Shipley St, San Francisco, CA 94107.
      </li>
      <li>
      ...
      <li>
        <strong>Website</strong> refers to Courier, accessible from
    ...
    <p>
      ...
      parties on the Service, you agree to use the Service at your own risk. You
    ...
    <p>
      ...
      copyright agent via email at support@courier.com and include in Your
    ...
    <p>
      Upon receipt of a notification, the Company will take whatever action, in
